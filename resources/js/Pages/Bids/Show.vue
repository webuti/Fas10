        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <jet-form-section @submitted="updateBid">
                    ...
                    <template #form>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <select
                                class="border-gray-300 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full dark:bg-gray-800 dark:text-white dark:border-gray-400"
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <jet-label for="category_id" value="Teklif" />
                        ...
                        <div         v-if="form.offer_type === 1" class="col-span-6 sm:col-span-4">
                ...
                <jet-form-section class="mt-10">
                    <template #form
                        >Sitede görünür olmasını istemiyorsanız ilanı yayından
                        kaldırabilirsiniz.</template
                    >
                    <template #actions>
    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                ...
                offer_type: this.bid.offer_type,
