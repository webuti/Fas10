                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <svg v-if="addTeamMemberForm.role == role.key"
                                             class="ml-2 h-5 w-5 text-blue-400" fill="none" stroke-linecap="round"
                        ...
                        <button type="button"
                            ...
                            <div :class="{'opacity-50': updateRoleForm.role && updateRoleForm.role !== role.key}">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <svg v-if="updateRoleForm.role === role.key" class="ml-2 h-5 w-5 text-blue-400"
