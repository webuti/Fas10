<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
           Mevcut şifrenizi değiştirmek isterseniz yandaki formu kullanabilirsiniz.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Mevcut şifreniz" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Yeni şifreniz" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Yeni şifreniz (tekrar)" />
